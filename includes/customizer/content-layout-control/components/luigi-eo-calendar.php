...
if ( !class_exists( 'Luigi_CLC_Component_EO_Calendar' ) ) {
	/**
	 * Calendar component which displays the Event Organiser calendar shortcode
	 *
	 * @since 0.1
	 */
	class Luigi_CLC_Component_EO_Calendar extends CLC_Component{
		...
		public function render_layout() {
			include( get_template_directory() . '/includes/customizer/content-layout-control/components/templates/luigi-eo-calendar.php' );
		}
		...
		public function control_template() {
			include( get_template_directory() . '/assets/js/content-layout-control/templates/components/luigi-eo-calendar.js' );
		}
	}
}
