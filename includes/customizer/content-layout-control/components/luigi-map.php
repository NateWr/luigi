...
if ( !class_exists( 'Luigi_CLC_Component_Map' ) ) {
	/**
	 * Map component which draws from the Business Profile address
	 *
	 * @since 0.1
	 */
	class Luigi_CLC_Component_Map extends CLC_Component{
		...
		public function render_layout() {
			include( get_template_directory() . '/includes/customizer/content-layout-control/components/templates/luigi-map.php' );
		}
		...
		public function control_template() {
			include( get_template_directory() . '/assets/js/content-layout-control/templates/components/luigi-map.js' );
		}
	}
}
